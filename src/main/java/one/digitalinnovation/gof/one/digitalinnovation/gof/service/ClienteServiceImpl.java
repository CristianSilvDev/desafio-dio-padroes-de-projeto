...
import one.digitalinnovation.gof.one.digitalinnovation.gof.model.ClienteRepository;
import one.digitalinnovation.gof.one.digitalinnovation.gof.model.Endereco;
import one.digitalinnovation.gof.one.digitalinnovation.gof.model.EnderecoRepository;
